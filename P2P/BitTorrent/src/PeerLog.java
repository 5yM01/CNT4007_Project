public class PeerLog {
    ...
    public static String log_Preferred_neighbor(Peer p1) {
        Peer[] neighborList = p1.getPreferredNeighbors();
        String prefList = "";
    ...
    public static String log_Downloaded_piece(Peer p1, int pID2) {
        int total = p1.currNumOfPieces();
        return String.format(downloaded_piece, p1.peerID, pID2, total);
    }
