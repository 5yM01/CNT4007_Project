	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int i = 0; i < myStart.peerInfoVector.size(); i++) {
				...
				//System.out.println(">ssh " + pInfo.peerAddress + " cd " + path + "; java PeerClient " + pInfo.peerId);
				Runtime.getRuntime().exec("ssh " + pInfo.peerAddress + " cd " + path + "; java PeerClient " + pInfo.peerId);
